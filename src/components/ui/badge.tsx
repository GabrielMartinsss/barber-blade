...
const badgeVariants = cva(
  'inline-flex items-center rounded-md border border-zinc-200 px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-zinc-950 focus:ring-offset-2 dark:border-zinc-800 dark:focus:ring-zinc-300',
  {
    variants: {
      variant: {
        default:
          'border-none bg-zinc-900 text-zinc-50 shadow hover:bg-zinc-900/80 dark:bg-primary-600/20 dark:text-primary-400 dark:hover:bg-primary-600/20',
        secondary:
          'border-transparent bg-zinc-100 text-zinc-900 hover:bg-zinc-100/80 dark:bg-zinc-800 dark:text-zinc-400 dark:hover:bg-zinc-800/80',
        destructive:
